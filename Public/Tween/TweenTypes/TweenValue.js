...
script.dataType = script.dataType > 4 ? script.dataType - 2 :script.dataType;//for rgb and rgba
...
function getCallbackFunction () {
    ...
    switch(script.callbackType) {
        ...
        case(1):        
            ...
            return function (v) { script.propTargetScript.api[script.propName] = v; }
        ...
        case(2):        
            ...
            return function (v) { script.funcTargetScript.api[script.funcName](v); }

        case (3): 
            if( !script.material) {
                print("[Tween Value], Warning, Material is not set");
                break;
            } 
            ...
            return function (v) { script.material.mainPass[script.materialScriptName] = v;} 
